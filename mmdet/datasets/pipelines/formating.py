...
class DefaultFormatBundle(object):
    ...
    def __call__(self, results):
        ...
        for key in ['proposals', 'gt_kpts', 'gt_bboxes', 'gt_bboxes_ignore', 'gt_labels', 'gt_masks_areas']:
        # for key in ['proposals', 'gt_kpts', 'gt_bboxes', 'gt_bboxes_ignore', 'gt_labels']:
...
class Collect(object):
    ...
    def __call__(self, results):
        ...
        for key in self.keys:
            # if key == 'ann_info':
            #     data['gt_kpts'] = results['ann_info']['keypoints']
            # else:
